        ...
        <div className="md:ml-32 md:mr-32 w-full xl:w-1/2">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            <span className="font-extrabold text-[#ffffff]">
              Organiza eventos y viajes
            </span>{" "}
            de manera{" "}
            <span className="italic underline">
              sencilla <span className="not-italic">y</span> efectiva.
            </span>
          </h1>
          ...
          <div className="flex max-w-max px-2 py-2">
            <div class="mx-auto flex flex-shrink-0 items-center space-x-2 sm:space-x-4">
              <button class="inline-flex items-center rounded-lg border border-transparent bg-blue-600 px-3 py-1.5 sm:px-4 sm:py-3 text-white hover:bg-blue-700 hover:border-blue-700 hover:shadow-lg focus:outline-none transition-all duration-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  class="h-7 w-5 sm:h-7 sm:w-9 text-white"
                  viewBox="0 0 512 512"
                >
                ...
                <span class="ml-2 flex flex-col items-start leading-none">
                  <span class="mb-0 sm:text-xs text-[10px] text-white">
                    GET IT ON
                  </span>
                  <span class="title-font sm:text-sm text-xs font-medium text-white">
                    Google Play
                  </span>
                </span>
              </button>
